// ESLint flat config for the vanilla-JS frontend (frontend/app/*.js modules,
// frontend/app.js, and the node-run *.test.mjs suites).
//
// Run from the repo root:
//   npx eslint frontend            # lint (must report zero problems)
//   npx eslint frontend --fix      # apply the autofixes
//
...
export default [
  {
    ...
    // node_modules is npm's own tree (lint tooling only, never served).
    ignores: ["frontend/vendor/**", "node_modules/**", "**/*.min.js"],
  },
