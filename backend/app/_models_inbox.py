...
class EmailOut(BaseModel):
    ...
    # USTA # parsed from the email text itself (not the matched player's) — set
    # for PDF-imported emails so the TD sees it even before a player is matched.
    detected_usta_text: Optional[str] = None
