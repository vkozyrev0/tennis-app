...
**Status:** 443 tests, all passing (migrations through 0046) — deterministic
...
python -m pytest -q                                    # the whole suite (443)
...
Total suite count: **443 tests, all passing** (see the status line at the top).
